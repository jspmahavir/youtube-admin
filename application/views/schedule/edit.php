<?php
$scheduleId = $scheduleInfo[0]['schedule_data_id'];
$schedule_url = $scheduleInfo[0]['schedule_url'];
$schedule_port = $scheduleInfo[0]['schedule_port'];
$username = $scheduleInfo[0]['username'];
?>
