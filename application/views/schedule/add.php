<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-sitemap"></i> Schedule Management
        <small>Add / Edit Schedule</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addSchedule" action="<?php echo base_url() ?>schedule/addNewSchedule" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="schedule_url">Schedule URL</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('schedule_url'); ?>" id="schedule_url" name="schedule_url" maxlength="128">
                                    </div>
                                    
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="schedule_port">Schedule Port</label>
                                        <input type="text" class="form-control required schedule_port" id="schedule_port" value="<?php echo set_value('schedule_port'); ?>" name="schedule_port" maxlength="5">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script src="<?php echo base_url(); ?>assets/js/scheduleAddEdit.js" type="text/javascript"></script>