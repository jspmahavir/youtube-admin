            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <table id="cmtdetail_data_table" class="display table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Video</th>
                                <th>Comment</th>
...
<script type="text/javascript" charset="utf-8">
    jQuery(document).ready(function(){
        ...
        jQuery('#cmtdetail_data_table').DataTable({
            processing: true,
            serverSide: true,
            order: [[5, 'desc']],
            ajax: "<?php echo base_url('commentdetail/detail?scheduleid='); ?>"+schid,
        });
    });
</script>
