            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="editClient" action="<?php echo base_url() ?>comment/editComment" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="comment">Comment</label>
                                        <input type="text" class="form-control required" id="comment" name="comment" value="<?php echo $comment; ?>" maxlength="256">
