<?php
$userId = $userInfo[0]['login_id'];
$name = $userInfo[0]['username'];
$lastLoginIP = $userInfo[0]['last_login_ip'];
$createDate = $userInfo[0]['created_date'];
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Last Login IP</b> <a class="pull-right"><?= $lastLoginIP ?></a>
                            </li>
                            <li class="list-group-item">
                                <b>Create Date</b> <a class="pull-right"><?= $createDate ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="username" name="username" placeholder="<?php echo $name; ?>" value="<?php echo set_value('username', $name); ?>" maxlength="128" />
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
